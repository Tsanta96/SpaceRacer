...
export default class Game {
	...
	gameOver() {
		if (this.level.collision(this.player.playerBounds()) === true) return true;
	}
	...
	changeLanes(event) {
		...
		if (event.key === "ArrowLeft") this.player.movePlayer(-1);
		else if (event.key === "ArrowRight") this.player.movePlayer(1);
	}
